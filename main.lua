...
local sheetWalkingNinja = graphics.newImageSheet( "Assets/ninjaBoyThrow.png", sheetOptionsWalk )
...
local function shootTouch ( event )   
    ...
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet = display.newImageRect( "Assets/bullet.png", 50, 25 )
...
local sheetWalkingNinja = graphics.newImageSheet( "Assets/ninjaBoyDead.png", sheetOptionsWalk )
